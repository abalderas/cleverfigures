...
<?	
echo "<h3>$i18n_content_evolution</h3>";
echo $content_evolution_chart;
echo "</br>";

echo "<h3>$i18n_activity</h3>";
echo $activity_chart;
echo "</br>";

echo "<h3>$i18n_users</h3>";
echo $users_chart;
echo "</br>";

echo "<h3>$i18n_pages</h3>";
echo $pages_chart;
echo "</br>";

echo "<h3>$i18n_categories</h3>";
echo $categories_chart;
echo "</br>";

echo "<h3>$i18n_tag_cloud</h3>";
echo $tag_cloud;
echo "</br>";
