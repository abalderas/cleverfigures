...
## Recieves database server, batabase name, batabase user, database user
## passsword and path to locate the file
...
\$db['main_db']['hostname'] = '$1';
\$db['main_db']['username'] = '$3';
\$db['main_db']['password'] = '$4';
\$db['main_db']['database'] = '$2';
...
/* Location: ./application/config/database.php */" > $5/database.php
