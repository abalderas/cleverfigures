	...
	if(isset($adate))
		for($i = 0; $i < count($adate); $i++){
			echo "<tr>";
				...
				echo "<td>".$awiki[$i]."</td>";
				echo "<td>".$acolor[$i]."</td>";
				echo "<td>".anchor('options_form/view/'.$adate[$i], lang('voc.i18n_view'))." - ".anchor('options_form/delete/'.$adate[$i], lang('voc.i18n_delete'), array('onClick' => "return confirm('".lang('voc.i18n_delete_analysis_confirmation')."');"))."</td>";
