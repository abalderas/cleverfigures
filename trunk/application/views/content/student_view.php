	...
	if(isset($adate))
		for($i = 0; $i < count($adate); $i++){
			echo "<tr>";
				...
				echo "<td>".$awiki[$i]."</td>";
				echo "<td>".$acolor[$i]."</td>";
				echo "<td>".anchor('options_form/studentview/'.$adate[$i]."/".$this->session->userdata('username'), lang('voc.i18n_view'))."</td>";
					
			echo "</tr>";
		}
	else echo "<tr><td colspan = \"4\">".lang('voc.i18n_nothing_shared')."</td></tr>";
?>
