...
class Dbforge_model extends CI_Model{
	...
	//METHODS
   	...
   	function build_database($dbname, $dbserver, $dbuser, $dbpassword){
		...
		$this->db->query("CREATE TABLE `wiki` ( `wiki_id` INT(9) UNSIGNED NOT NULL AUTO_INCREMENT, `wiki_name` VARCHAR(50) NOT NULL, `wiki_baseurl` VARCHAR(70), `wiki_connection` INT(6) NOT NULL, `wiki_quality_function` VARCHAR(100) NOT NULL KEY `wiki_id` (`wiki_id`) ) DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci");
		...
		$this->db->query("CREATE TABLE `student-analysis` ( `student_name` VARCHAR(30) NOT NULL, `analisis_date` VARCHAR(50) NOT NULL, KEY `student_name` (`student_name`) ) DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci");
   	}
}
