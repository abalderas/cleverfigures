...
class Merging_model extends CI_Model{
  ...
  function merge_save_users($wikiname, $analisis, $colorname = 'default', $date_range_a = 'default',
    $date_range_b = 'default', $filter_page = 'default', $filter_category = 'default') {
    ...
    if ($colorname != 'default') {
      ...
      //merges it with wiki info, adding it to local database
  ...
  function save_pages($wikiname, $analisis, /*$colorname = 'default',*/ $date_range_a = 'default',
    $date_range_b = 'default', $filter_user = 'default') {
  ...
  function save_categories($wikiname, $analisis, /*$colorname = 'default',*/ $date_range_a = 'default',
    $date_range_b = 'default', $filter_page = 'default', $filter_user = 'default'){

    //Fetching cats info from wiki
      $wikidata = $this->wiki_model->fetch_categories($wikiname, $date_range_a, $date_range_b, $filter_page,
        $filter_user);
  ...
  function save_images($wikiname, $analisis, /*$colorname = 'default',*/ $date_range_a = 'default',
    $date_range_b = 'default', $filter_page = 'default', $filter_user = 'default', $filter_category = 'default') {
    ...
    //Merge it with wiki info, adding it to local database
  ...
  function save_content_evolution($wikiname, $analisis, $colorname = 'default', $date_range_a = 'default',
    $date_range_b = 'default', $filter_user = 'default', $filter_page = 'default', $filter_category = 'default') {
  ...
  function save_activity($wikiname, $analisis, $colorname = 'default', $date_range_a = 'default',
    $date_range_b = 'default', $filter_user = 'default', $filter_page = 'default', $filter_category = 'default') {
